...
try:
    ...
    from hive_tables_column_counts import HiveTablesColumnCounts
...
class ImpalaTablesColumnCounts(HiveTablesColumnCounts):

    def __init__(self):
        # Python 2.x
        super(ImpalaTablesColumnCounts, self).__init__()
        # Python 3.x
        # super().__init__()
