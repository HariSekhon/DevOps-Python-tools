...
You can also get this from the schemas.csv output generated by impala_schemas_csv.py, eg.

    tail -n +2 impala_schemas.csv | cut -d, -f1,2 | sed 's/"//g; s/,/./' | sort | uniq -c | sort -k1nr
