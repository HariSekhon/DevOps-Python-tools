...
Connect to an Impala daemon and count the number of rows and columns for each table
...
try:
    ...
    from hive_tables_row_column_counts import HiveTablesRowColumnCounts
...
class ImpalaTablesRowColumnCounts(HiveTablesRowColumnCounts):

    def __init__(self):
        # Python 2.x
        super(ImpalaTablesRowColumnCounts, self).__init__()
        # Python 3.x
        # super().__init__()
...
if __name__ == '__main__':
    ImpalaTablesRowColumnCounts().main()
