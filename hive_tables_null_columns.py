...
Describes each table to construct a large query based on all detected columns,
then queries the columns for NULLs and prints the tables columns containing only NULLs
