...
Tool to return the active Presto Coordinator from an argument list of hosts
...
class FindActivePrestoCoordinator(FindActiveServer):

    def __init__(self):
        # Python 2.x
        super(FindActivePrestoCoordinator, self).__init__()
        # Python 3.x
        # super().__init__()
        self.default_port = 8080
        self.protocol = 'http'
        self.url_path = '/v1/service/presto/general'
        self.regex = r'coordinator.+true'
        self.default_num_threads = 2

    def add_options(self):
        self.add_hostoption(name='Presto Coordinator', default_port=self.default_port)
        self.add_ssl_opt()
...
if __name__ == '__main__':
    FindActivePrestoCoordinator().main()
