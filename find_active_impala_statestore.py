...
Tool to return the first active Impala Statestore from an argument list of hosts
...
class FindActiveImpalaStatestore(FindActiveServer):

    def __init__(self):
        # Python 2.x
        super(FindActiveImpalaStatestore, self).__init__()
        # Python 3.x
        # super().__init__()
        self.default_port = 25010
        self.protocol = 'http'
        self.regex = r'\bstatestored\b'

    def add_options(self):
        self.add_hostoption(name='Impala StateStore', default_port=self.default_port)
        self.add_ssl_opt()
...
if __name__ == '__main__':
    FindActiveImpalaStatestore().main()
