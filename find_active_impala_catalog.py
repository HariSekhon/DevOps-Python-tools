...
Tool to return the first active Impala Catalog from an argument list of hosts
...
class FindActiveImpalaImpalaCatalog(FindActiveServer):

    def __init__(self):
        # Python 2.x
        super(FindActiveImpalaImpalaCatalog, self).__init__()
        # Python 3.x
        # super().__init__()
        self.default_port = 25020
        self.protocol = 'http'
        self.regex = r'\bcatalogd\b'

    def add_options(self):
        self.add_hostoption(name='Impala Catalog', default_port=self.default_port)
        self.add_ssl_opt()
...
if __name__ == '__main__':
    FindActiveImpalaImpalaCatalog().main()
