...
try:
    ...
    from hive_tables_locations import HiveTablesLocations
...
class ImpalaTablesLocations(HiveTablesLocations):

    def __init__(self):
        # Python 2.x
        super(ImpalaTablesLocations, self).__init__()
        # Python 3.x
        # super().__init__()
